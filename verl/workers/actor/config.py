...
class ActorConfig:
    ...
    seg_loss_coef: float = 0.3
    conf_loss_coef: float = 0.2
    heatmap_dice_rate: float = 1.0
    dice_loss_coef: float = 0.8
    dice_loss_coef_new: float = 0.7
    focal_loss_coef: float = 0.0
    focal_loss_coef_new: float = 0.5
    adjust_loss_step: int = -1
    kl_loss_coef: float = 0.2
    entropy_coef: float = 2.0e-5
